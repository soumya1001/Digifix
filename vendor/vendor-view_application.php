...
if(!isset($_SESSION['email'])){
  header('location:http://localhost/digifix/login.php');
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $sql= "UPDATE `digifix`.`complaint_approve` SET `status` = '$status',`user_confirmation` = '$user_confirmation' WHERE `complaint_approve`.`complaint_no` = $complaint_no;";
        ...
        <div class="row">
            ...
            <div class="input-box">
              ...
              <div class="input-box" >
                ...
                <input readonly name="problem" placeholder="write your Problem in Details" value="<?php echo $problem; ?>" required></input>  
              </div>
              
              <div class="input-box" >
                    <span class="details">problem Details</span>
                    <textarea readonly name="details" cols="80" rows="5" required><?php echo $details; ?></textarea>  
              </div>

              <div class="input-box" >
                    <span class="details">Department</span>
                    <textarea readonly name="address" value="<?php echo $address; ?>" required><?php echo $address; ?></textarea>  
              </div>
            
            </div>
            <div class="input-box">
                <span class="details">Last Status</span>
                <input readonly value="<?php echo $status; ?>" type="text" name="status" placeholder="Enter status" required>
              </div>

            <div class="input-box">
            <span class="details">Update Current Status</span>
            ...
            <div class="button">
              <input value="Update status" type="submit"> 
            </div>
