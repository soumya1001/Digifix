...
if(!isset($_SESSION['email'])){
  header('location:http://localhost/digifix/login.php');
    ...
    $sql="select * from `digifix`.`admin` where email='$email'";
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $sql2 = "UPDATE `digifix`.`admin` SET `name` = '$name', `phone` = '$phone', `email` = '$email'  WHERE `admin`.`email` = '$email';";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                <label>Email</label>
                                <input value="<?php echo $email; ?>" type="email" name="email" class="form-control" readonly>
                            </div>
                            <div class="mb-3">
                                <label>Phone</label>
